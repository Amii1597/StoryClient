...
import leftSlide from "../../../assets/Left.png"
import rightSlide from "../../../assets/Right.png"
import saveSlide from "../../../assets/saveSlide.png"
import savedSlide from "../../../assets/Bookmarked2.webp"
import shareSlide from "../../../assets/tabler_send.svg"
...
async function fetchStoryByID(storyID) {
  try {
    const response = await axios.get(
      `https://swiptory22.onrender.com/story/${storyID}`
    );
...
async function setBookmark(storyID, setBookmarkChng) {
  try {
    ...
    const response = await axios.post(
      "https://swiptory22.onrender.com/bookmark",
      payload,
      {
        headers: {
...
async function isBookmarked(storyID, setBookmarkChng) {
  try {
    ...
    const response = await axios.get(
      `https://swiptory22.onrender.com/bookmark/${username}?storyID=${storyID}`,
      {
        headers: {
          "content-type": "application/x-www-form-urlencoded",
          token: localStorage.getItem("token"),
...
async function setLike(storyID, iteration, setLikeChng) {
  try {
    ...
    const response = await axios.post(
      "https://swiptory22.onrender.com/like",
      payload,
      {
        headers: {
          "content-type": "application/x-www-form-urlencoded",
...
async function isLiked(storyID, iteration, setLikeChng) {
  try {
    ...
    const response = await axios.get(
      `https://swiptory22.onrender.com/like/${storyID}?iteration=${iteration}&username=${user}`,
      {
        headers: {
          "content-type": "application/x-www-form-urlencoded",
          token: localStorage.getItem("token"),
