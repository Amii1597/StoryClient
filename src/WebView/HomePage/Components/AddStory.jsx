...
export default function AddStory(props) {
      ...
      try {
        setTimeout(async () => {
          const response = await axios.post(
            "https://swiptory22.onrender.com/story",
            item,
            {
              headers: {
  ...
  return (
    ...
    <div className="ADDSTORY">
      <img src={close} alt=""  className="close1" />
      <p className="heading_name">Add story to feed</p>
      <div className="addstory">
      ...
      <div className="changeslidesection">
        ...
        {/* <button className="submitbtn" onClick={handleFormSubmit}>Post</button>
        <div className="changeslidesection"> */}
        <button
          onClick={() => {
...
async function getStoryID() {
  try {
    let id = await axios.get("https://swiptory22.onrender.com/storyid");
